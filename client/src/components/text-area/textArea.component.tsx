...
const TextArea = ({buttonText, textAreaText}: {buttonText: string, textAreaText: string}) => {
  return (
   <form>
   <div className="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div className="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
           <label htmlFor="editor" className="sr-only">{textAreaText}</label>
           <textarea id="editor" rows={8} className="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder={textAreaText} required></textarea>
       </div>
   </div>
