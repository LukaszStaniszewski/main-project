...
import { AppState } from "../../client/src/store/root-reducer";
...
declare global {
   namespace Cypress {
      interface Chainable<Subject> {
         ...
         urlShouldEq(url: string): Chainable<Subject>;
         deleteCollectionByRedux(collectionId: string): Chainable<Subject>;
      }
   }
}
